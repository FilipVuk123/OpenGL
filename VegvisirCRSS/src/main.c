...
int main()
{
    ...
    orqa_window_t CRSS = orqa_create_window(1.0, 130, 60, 0, 0, 1);
    ...
    // orqa_load_texture_from_file("/home/filip/Desktop/ORQA/OpenGL/VegvisirCRSS/data/MRSS.png");
    ...
    { // render loop
        ...
        orqa_update_texture_from_buffer(GL_TEXTURE_2D, 0,0, width, height, GL_RGB, GL_UNSIGNED_INT, NULL);
